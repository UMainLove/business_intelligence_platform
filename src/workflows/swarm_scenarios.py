        ...
        try:
            ...
            return {
                ...
                'overall_metrics': {
                    ...
                    'high_probability_risks': len([r for r in scenario_results.values() if r.probability > 0.3]),
                    'high_impact_scenarios': len([r for r in scenario_results.values() if r.impact_score > 7])
                },
