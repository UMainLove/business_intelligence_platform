...
class BusinessDataDB:
    ...
    def populate_sample_data(self):
        ...
        ventures = [
            ("TechStart", "SaaS", "2019-01-15", "active", 1000000, 5000000, 25000000, 45, 3000000, "North America", "subscription"),
            ("EcommerceNow", "E-commerce", "2018-03-20", "acquired", 500000, 12000000, 80000000, 120, 15000000, "Europe", "marketplace"),
            ("FinTechInc", "FinTech", "2020-06-10", "active", 2000000, 15000000, 100000000, 80, 8000000, "Asia", "B2B"),
            ("FailedStartup", "HealthTech", "2017-08-05", "failed", 800000, 800000, 0, 0, 0, "North America", "B2C"),
            ("UnicornCorp", "AI/ML", "2016-12-01", "ipo", 5000000, 150000000, 2000000000, 500, 50000000, "North America", "enterprise")
        ]
    ...
    def query_industry_success_rates(self, industry: str) -> Dict[str, Any]:
        ...
        analysis['success_rate'] = round((success_count / total_ventures * 100), 1) if total_ventures > 0 else 0
    ...
    def analyze_similar_ventures(self, industry: str, business_model: str, region: str = None) -> Dict[str, Any]:
