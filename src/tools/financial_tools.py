...
from src.error_handling import (
    ValidationError, handle_errors, retry_with_backoff, validate_input,
    safe_execute, track_errors
)
...
class FinancialCalculator:
    ...
    @staticmethod
    def calculate_break_even(fixed_costs: float, price_per_unit: float, variable_cost_per_unit: float) -> int:
    ...
    def unit_economics_analysis(
        ...
        months_to_recover_cac = customer_acquisition_cost / average_revenue_per_user if average_revenue_per_user > 0 else float('inf')
    ...
    return {
        ...
        "parameters": {
            ...
            "properties": {
                "operation": {
                    "type": "string",
                    "enum": ["npv", "irr", "payback", "break_even", "roi", "projection", "unit_economics", "execute_code"],
