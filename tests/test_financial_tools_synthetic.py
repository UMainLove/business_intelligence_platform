...
class TestFinancialCalculatorSynthetic:
    ...
    def test_calculate_break_even(self):
        ...
        break_even = self.calc.calculate_break_even(
    ...
    def test_generate_financial_projection(self):
        ...
        projection = self.calc.generate_financial_projection(
            initial_revenue=100000, growth_rate=0.2, years=3, operating_margin=0.25, tax_rate=0.3
        )
...
class TestFinancialToolExecutor:
    ...
    def test_npv_operation(self):
        ...
        result = financial_tool_executor(
            "npv", {"cash_flows": [-1000, 300, 400, 500], "discount_rate": 0.1}
        )
    ...
    def test_roi_operation(self):
        ...
        result = financial_tool_executor("roi", {"gain": 1500, "cost": 1000})
    ...
    def test_projection_operation(self):
        ...
        result = financial_tool_executor(
            "projection", {"initial_revenue": 100000, "growth_rate": 0.2, "years": 3}
        )
...
class TestFinancialMetrics:
    ...
    def test_financial_metrics_creation(self):
        ...
        metrics = FinancialMetrics(
            npv=1000.0, irr=0.15, payback_period=3.5, break_even_point=500, roi=25.0
        )
