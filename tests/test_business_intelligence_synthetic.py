...
class TestBusinessIntelligenceAgent:
    ...
    def test_create_tool_function_financial(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "financial_calculator")
    ...
    def test_create_tool_function_rag(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "market_research_rag")
    ...
    def test_create_tool_function_web_search(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "web_search")
    ...
    def test_create_tool_function_database(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "business_database")
    ...
    def test_create_tool_function_document(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "document_generator")
    ...
    def test_create_tool_function_api(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "external_api")
    ...
    def test_create_tool_function_unknown(self):
        ...
        tool_func = BusinessIntelligenceAgent._create_tool_function(agent, "unknown_tool")
...
class TestToolsListCreation:
    ...
    def test_create_bi_tools_list(
        self, mock_api, mock_doc, mock_db, mock_web, mock_rag, mock_financial
    ):
...
class TestToolsIntegration:
    ...
    @patch("src.business_intelligence.create_document_tool_spec")
    @patch("src.business_intelligence.create_api_tool_spec")
    def test_create_bi_tools_list_all_tools(
        self, mock_api, mock_doc, mock_db, mock_web, mock_rag, mock_financial
    ):
