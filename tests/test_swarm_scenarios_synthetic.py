...
class TestSwarmScenarioAnalysis:
    ...
    def test_analyze_optimistic_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.OPTIMISTIC], 'generate_reply') as mock_reply:
            mock_reply.return_value = "Optimistic analysis: High growth potential with strong market adoption"
    ...
    def test_analyze_pessimistic_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.PESSIMISTIC], 'generate_reply') as mock_reply:
            mock_reply.return_value = "Pessimistic analysis: Significant challenges and risks identified"
            
            business_data = {
                "business_idea": "Risky Venture",
    ...
    def test_analyze_economic_downturn_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.ECONOMIC_DOWNTURN], 'generate_reply') as mock_reply:
    ...
    def test_analyze_competitive_threat_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.COMPETITIVE_THREAT], 'generate_reply') as mock_reply:
    ...
    def test_analyze_regulatory_change_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.REGULATORY_CHANGE], 'generate_reply') as mock_reply:
    ...
    def test_analyze_technology_disruption_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.TECHNOLOGY_DISRUPTION], 'generate_reply') as mock_reply:
    ...
    def test_analyze_black_swan_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.BLACK_SWAN], 'generate_reply') as mock_reply:
    ...
    def test_analyze_realistic_scenario(self):
        ...
        # Mock agent response
        with patch.object(analysis.scenario_agents[ScenarioType.REALISTIC], 'generate_reply') as mock_reply:
            mock_reply.return_value = "Realistic analysis: Balanced view of opportunities and challenges"
...
class TestSwarmIntegration:
    ...
    def test_scenario_prompt_generation(self):
        ...
        with patch.object(analysis.scenario_agents[ScenarioType.OPTIMISTIC], 'generate_reply', side_effect=capture_prompt):
