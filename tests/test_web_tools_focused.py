...
class TestWebSearchTool:
    ...
    def test_search_time_format(self):
        ...
        parsed_dt = datetime.fromisoformat(search_time.replace('Z', '+00:00') if search_time.endswith('Z') else search_time)
...
class TestWebSearchExecutor:
    ...
    def test_companies_search_executor(self):
        ...
        result = web_search_executor("companies", {
            "company_name": "ExecutorTestCorp",
            "location": "New York"
        })
    ...
    def test_market_trends_executor(self):
        ...
        result = web_search_executor("market_trends", {
            "industry": "ExecutorIndustry",
            "timeframe": "3y"
        })
    ...
    def test_competitors_search_executor(self):
        ...
        result = web_search_executor("competitors", {
            "business_idea": "ExecutorIdea",
            "target_market": "ExecutorMarket"
        })
    ...
    def test_regulations_search_executor(self):
        ...
        result = web_search_executor("regulations", {
            "industry": "ExecutorRegIndustry",
    ...
    def test_funding_search_executor(self):
        ...
        result = web_search_executor("funding", {
            "industry": "ExecutorFundingIndustry",
            "stage": "ExecutorStage"
        })
