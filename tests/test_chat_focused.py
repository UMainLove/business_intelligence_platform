...
class TestConstructGroupFromMemory:
    ...
    def test_construct_group_from_memory_success(self, mock_manager, mock_chat, mock_agent, 
                                                 mock_settings, mock_compose, mock_anthropic):
            ...
            with patch('src.chat.lawyer_prompt', return_value="Lawyer prompt"):
                with patch('src.chat.sociologist_prompt', return_value="Sociologist prompt"):
                    with patch('src.chat.synthesizer_prompt', return_value="Synthesizer prompt"):
                        ...
                        assert mock_agent.call_count >= 4  # economist, lawyer, sociologist, user_proxy, synthesizer
    ...
    @patch('src.chat.GroupChat')
    @patch('src.chat.GroupChatManager')
    def test_construct_group_agent_names(self, mock_manager, mock_chat, mock_agent, 
                                        mock_settings, mock_compose, mock_anthropic):
...
class TestUpdateMemoryFromChat:
    ...
    @patch('src.chat.set_memory')
    def test_update_memory_from_chat_success(self, mock_set_memory, mock_build_memory, mock_build_group):
    ...
    @patch('src.chat.build_memory_from_messages')
    @patch('src.chat.set_memory')
    def test_update_memory_from_chat_empty_messages(self, mock_set_memory, mock_build_memory, mock_build_group):
