...
class TestHealthMonitor:
    ...
    @patch.object(HealthMonitor, 'get_system_metrics')
    def test_get_comprehensive_health_healthy(self, mock_metrics, mock_resources, mock_errors, mock_db):
    ...
    @patch.object(HealthMonitor, 'check_system_resources')
    @patch.object(HealthMonitor, 'get_system_metrics')
    def test_get_comprehensive_health_degraded(self, mock_metrics, mock_resources, mock_errors, mock_db):
    ...
    @patch.object(HealthMonitor, 'check_system_resources')
    @patch.object(HealthMonitor, 'get_system_metrics')
    def test_get_comprehensive_health_unhealthy(self, mock_metrics, mock_resources, mock_errors, mock_db):
