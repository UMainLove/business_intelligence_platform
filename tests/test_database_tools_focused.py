...
class TestBusinessDataDB:
    ...
    def test_add_venture_minimal_data(self):
        ...
        venture_data = {"name": "MinimalVenture", "industry": "MinimalIndustry"}
        ...
        cursor = conn.cursor()
        cursor.execute(
            "SELECT name, industry, status FROM business_ventures WHERE id = ?", (venture_id,)
        )
        result = cursor.fetchone()
        conn.close()
    ...
    def test_database_persistence(self):
        ...
        venture_data = {"name": "PersistentVenture", "industry": "TestIndustry"}
...
class TestDatabaseToolExecutor:
    ...
    def test_add_venture_executor(self, mock_db_class):
        ...
        venture_data = {"name": "NewVenture", "industry": "NewTech"}
