...
class TestHealthMonitor:
    ...
    def test_get_comprehensive_health_all_healthy(
        self, mock_error_check, mock_db_check, mock_system_check
    ):
        ...
        mock_error_check.return_value = HealthStatus(
            status="healthy",
            message="OK",
    ...
    @patch("src.health_monitor.HealthMonitor.check_database_health")
    @patch("src.health_monitor.HealthMonitor.check_error_rate")
    def test_get_comprehensive_health_mixed(
        self, mock_error_check, mock_db_check, mock_system_check
    ):
        ...
        mock_db_check.return_value = HealthStatus(
            status="degraded", message="Slow response", details={}, timestamp="2024-01-01T00:00:00"
        )
        mock_error_check.return_value = HealthStatus(
            status="unhealthy",
            message="High errors",
            details={"total_errors": 100},
            timestamp="2024-01-01T00:00:00",
        )
