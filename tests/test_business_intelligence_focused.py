                ...
                with patch("src.business_intelligence.ConversableAgent") as mock_user:
                    with patch("src.business_intelligence.GroupChat") as mock_chat:
                        with patch("src.business_intelligence.GroupChatManager") as mock_manager:
                            with patch(
                                "src.business_intelligence.SequentialValidationWorkflow"
                            ) as mock_workflow:
                                with patch(
                                    "src.business_intelligence.SwarmScenarioAnalysis"
                                ) as mock_swarm:
                                    # Mock instances
                                    ...
                                    )  # economist, lawyer, sociologist, synthesizer
                                ...
                                with patch("src.business_intelligence.BusinessIntelligenceAgent"):
                                    with patch("src.business_intelligence.ConversableAgent"):
                                        with patch("src.business_intelligence.GroupChat"):
                                            with patch(
                                                "src.business_intelligence.GroupChatManager"
                                            ):
                                                with patch(
                                                    "src.business_intelligence.SequentialValidationWorkflow"
                                                ):
                                                    with patch(
                                                        ...
                                                        with patch(
                                                            "src.business_intelligence.settings"
                                                        ):
                                                            build_bi_group()
                            ...
                            with patch(
                                ...
                                with patch(
                                    ...
                                    with patch(
                                        ...
                                        with patch(
                                            "src.business_intelligence._compose_system"
                                        ) as mock_compose:
                                            # Mock all prompt functions
                                            with patch(
                                                "src.business_intelligence.economist_prompt"
                                            ) as mock_econ:
                                                with patch(
                                                    "src.business_intelligence.lawyer_prompt"
                                                ) as mock_law:
                                                    with patch(
                                                        "src.business_intelligence.sociologist_prompt"
                                                    ) as mock_soc:
                                                        with patch(
                                                            "src.business_intelligence.synthesizer_prompt"
                                                        ) as mock_synth:
