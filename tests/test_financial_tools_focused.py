...
class TestCreateFinancialToolSpec:
    ...
    def test_create_financial_tool_spec_operations(self):
        ...
        expected_operations = [
            ...
            "projection", "unit_economics", "execute_code"
        ]
...
class TestIntegration:
    ...
    def test_tool_executor_all_operations(self):
        ...
        operations = [
            ...
            ("break_even", {"fixed_costs": 5000, "price_per_unit": 25, "variable_cost_per_unit": 15}),
            ("roi", {"gain": 1250, "cost": 1000}),
            ("projection", {"initial_revenue": 50000, "growth_rate": 0.15, "years": 2}),
            ("unit_economics", {"customer_acquisition_cost": 50, "customer_lifetime_value": 200, "monthly_churn_rate": 0.05, "average_revenue_per_user": 25}),
