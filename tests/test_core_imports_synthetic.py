...
class TestCoreImports:
    ...
    def test_workflows_import(self):
        ...
        from src.workflows.swarm_scenarios import SwarmScenarioAnalysis, ScenarioType, ScenarioResult
...
class TestModuleCompatibility:
    ...
    def test_error_handling_basic_functionality(self):
        ...
        from src.error_handling import safe_execute, ValidationError
...
class TestBasicFunctionality:
    ...
    def test_validation_functions(self):
        ...
        from src.error_handling import validate_input, ValidationError
