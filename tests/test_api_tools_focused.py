...
class TestExternalAPITool:
    ...
    def test_batch_api_call(self, mock_sleep):
        ...
        requests_data = [
            ...
            {
                "api_type": "regulations",
                "params": {"industry": "Tech", "region": "EU"}
            },
            {
                "api_type": "funding_intel",
                "params": {"industry": "SaaS", "stage": "Seed"}
            }
        ]
...
class TestAPIToolExecutor:
    ...
    def test_patent_search_executor(self):
        ...
        result = api_tool_executor("patent_search", {
            "company_name": "Apple",
            "keywords": ["iPhone", "iOS"]
        })
    ...
    def test_regulations_executor(self):
        ...
        result = api_tool_executor("regulations", {
            "industry": "Healthcare",
            "region": "EU"
        })
    ...
    def test_funding_intel_executor(self):
        ...
        result = api_tool_executor("funding_intel", {
            "industry": "Crypto",
            "stage": "Series C"
        })
    ...
    def test_batch_executor(self, mock_sleep):
        ...
        batch_requests = [
            {
                "api_type": "company_search",
                "params": {"company_name": "BatchCorp1"}
            },
            {
                "api_type": "market_data", 
                "params": {"symbol": "BATCH"}
...
class TestIntegration:
    ...
    def test_datetime_formats(self):
        ...
        parsed_dt = datetime.fromisoformat(retrieved_at.replace('Z', '+00:00') if retrieved_at.endswith('Z') else retrieved_at)
