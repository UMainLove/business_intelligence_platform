...
class TestHealthMonitor:
    ...
    def test_get_comprehensive_health_all_healthy(self):
        ...
        monitor.check_database_health = Mock(return_value=HealthStatus(
            "healthy", "DB OK", {}, "2024-01-01"
        ))
        monitor.check_error_rate = Mock(return_value=HealthStatus(
            "healthy", "No errors", {}, "2024-01-01"
        ))
        monitor.check_system_resources = Mock(return_value=HealthStatus(
            "healthy", "Resources OK", {}, "2024-01-01"
        ))
        monitor.get_system_metrics = Mock(return_value={
            "cpu_usage_percent": 50
        })
    ...
    def test_get_comprehensive_health_degraded(self):
        ...
        monitor.check_error_rate = Mock(return_value=HealthStatus(
            "degraded", "Some errors", {"total_errors": 10}, "2024-01-01"
        ))
        monitor.check_system_resources = Mock(return_value=HealthStatus(
            "healthy", "Resources OK", {}, "2024-01-01"
        ))
    ...
    def test_get_comprehensive_health_unhealthy(self):
        ...
        monitor.check_error_rate = Mock(return_value=HealthStatus(
            "degraded", "Some errors", {}, "2024-01-01"
        ))
        monitor.check_system_resources = Mock(return_value=HealthStatus(
            "healthy", "Resources OK", {}, "2024-01-01"
        ))
    ...
    def test_get_comprehensive_health_all_unhealthy(self):
        ...
        monitor.check_database_health = Mock(return_value=HealthStatus(
            "unhealthy", "DB Error", {}, "2024-01-01"
        ))
        monitor.check_error_rate = Mock(return_value=HealthStatus(
            "unhealthy", "High errors", {}, "2024-01-01"
        ))
        monitor.check_system_resources = Mock(return_value=HealthStatus(
            "unhealthy", "Resources critical", {}, "2024-01-01"
        ))
        monitor.get_system_metrics = Mock(return_value={})
