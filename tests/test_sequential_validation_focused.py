...
class TestWorkflowExecution:
    ...
    @patch('src.workflows.sequential_validation.ConversableAgent')
    def test_run_full_validation(self, mock_agent_class, mock_api, mock_doc, 
                                 mock_db, mock_web, mock_rag, mock_financial):
        ...
        report = workflow.run_full_validation(
            initial_data={"idea": "AI platform"}
        )
...
class TestToolsIntegration:
    ...
    @patch('src.workflows.sequential_validation.document_tool_executor')
    @patch('src.workflows.sequential_validation.api_tool_executor')
    def test_all_tools_called(self, mock_api, mock_doc, mock_db, 
